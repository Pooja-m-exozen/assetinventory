...
export default function MaintenancesFormPage() {
  const [fields, setFields] = useState<FormField[]>([
    { id: "title", label: "Title", type: "text", required: true },
    { id: "details", label: "Details", type: "textarea" },
    { id: "due-date", label: "Due Date", type: "date", placeholder: "MM/dd/yyyy" },
    { id: "maintenance-by", label: "Maintenance By", type: "text" },
    { id: "maintenance-status", label: "Maintenance Status", type: "dropdown", placeholder: "Select Status" },
    { id: "date-completed", label: "Date completed", type: "date", placeholder: "MM/dd/yyyy" },
    { id: "maintenance-cost", label: "Maintenance Cost", type: "text" }
  ]);
  ...
  return (
    <div className="container-fluid p-4" style={{ fontFamily: 'Inter, system-ui, -apple-system, sans-serif', backgroundColor: '#F5F5F5', minHeight: '100vh' }}>
      ...
      <div className="d-flex align-items-center mb-4">
        ...
        <h1 className="mb-0 fw-bold" style={{ fontSize: '24px', color: '#000' }}>Customize Maintenance Form</h1>
      </div>
      ...
      <div className="card mb-4" style={{ border: '1px solid #E0E0E0', borderRadius: '4px', boxShadow: 'none' }}>
        <div className="card-body p-4" style={{ backgroundColor: '#FFFFFF' }}>
          <p className="text-muted mb-0" style={{ fontSize: '14px', color: '#666', lineHeight: '1.6' }}>
            AssetTiger allows you to customize the way your data should be shown and entered for a maintenance. You can move fields to place more important items at the top for easy reading.
          </p>
        </div>
      </div>
