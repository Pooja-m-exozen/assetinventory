...
export default function PersonEmployeeFormPage() {
  const [fields, setFields] = useState<FormField[]>([
    ...
    { id: "site", label: "Site", type: "dropdown", placeholder: "Select Site" },
    { id: "location", label: "Location", type: "dropdown", placeholder: "Select Location" },
    { id: "department", label: "Department", type: "dropdown", placeholder: "Select Department" },
  ...
  return (
    <div className="container-fluid p-4" style={{ fontFamily: 'Inter, system-ui, -apple-system, sans-serif', backgroundColor: '#F5F5F5', minHeight: '100vh' }}>
      ...
      <div className="d-flex align-items-center mb-4">
        <Users className="me-2" style={{ color: '#666', width: '24px', height: '24px' }} />
        <h1 className="mb-0 fw-bold" style={{ fontSize: '24px', color: '#000' }}>Customize Persons/Employees Form</h1>
      </div>
      ...
      <div className="card mb-4" style={{ border: '1px solid #E0E0E0', borderRadius: '4px', boxShadow: 'none' }}>
        <div className="card-body p-4" style={{ backgroundColor: '#FFFFFF' }}>
          <p className="text-muted mb-0" style={{ fontSize: '14px', color: '#666', lineHeight: '1.6' }}>
            AssetTiger allows you to customize the way your data should be shown and entered for an individual person/employee. You can move fields to place more important items at the top for easy reading.
          </p>
        </div>
      </div>
