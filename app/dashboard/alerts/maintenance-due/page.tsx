        ...
        <div className="p-6">
          ...
          <div className="flex items-center justify-between mb-4">
            <div className="flex items-center gap-3">
              ...
              >
                ...
                <span style={{ fontFamily: 'Inter, system-ui, -apple-system, sans-serif', fontSize: '14px' }}>List of Maintenance Due</span>
              </Button>
              <Button
          ...
          <div className="mb-4">
            ...
            <p className="text-xs text-gray-600 dark:text-gray-400 mt-1" style={{ fontFamily: 'Inter, system-ui, -apple-system, sans-serif' }}>
              Maintenances that are due within the configured time period.
            </p>
          </div>
