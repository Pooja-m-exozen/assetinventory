...
export default function LeasesExpiringPage() {
  ...
  const handleImportLease = () => {
    console.log("Importing lease...");
  };
          ...
          <div className="flex items-center justify-between mb-4">
            <div className="flex items-center gap-3">
              ...
              >
                ...
                <span style={{ fontFamily: 'Inter, system-ui, -apple-system, sans-serif', fontSize: '14px' }}>List of Leases Expiring</span>
              </Button>
              <Button
            ...
            <div className="flex items-center gap-3">
              ...
              <Button
                variant="outline"
                onClick={handleImportLease}
                className="flex items-center gap-2 border-gray-300"
                style={{ fontFamily: 'Inter, system-ui, -apple-system, sans-serif' }}
              >
                <Upload className="h-4 w-4" />
                <span>Import Lease</span>
              </Button>
              <Button
                variant="outline"
                className="flex items-center gap-2 border-gray-300"
              ...
              <tbody className="divide-y divide-gray-200 dark:divide-gray-700">
                {paginatedLeases.length === 0 ? (
                  ...
                  paginatedLeases.map((lease) => (
                    <tr key={lease.id} className="hover:bg-gray-50 dark:hover:bg-gray-900 transition-colors">
