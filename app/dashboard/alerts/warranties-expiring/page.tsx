...
export default function WarrantiesExpiringPage() {
  ...
  const handleImportWarranty = () => {
    console.log("Importing warranty...");
  };
        ...
        <div className="p-6">
          ...
          <div className="flex items-center justify-between mb-4">
            <div className="flex items-center gap-3">
              ...
              >
                ...
                <span style={{ fontFamily: 'Inter, system-ui, -apple-system, sans-serif', fontSize: '14px' }}>List of Warranties Expiring</span>
              </Button>
              <Button
          ...
          <div className="mb-4">
            <select
              ...
              style={{ fontFamily: 'Inter, system-ui, -apple-system, sans-serif' }}
            >
              <option value="overdue">Warranties Expiring</option>
            ...
            <p className="text-xs text-gray-600 dark:text-gray-400 mt-1" style={{ fontFamily: 'Inter, system-ui, -apple-system, sans-serif' }}>
              Warranties that are expiring within the configured time period.
            </p>
          </div>
            ...
            <table className="w-full">
              <thead className="bg-yellow-50 dark:bg-yellow-900/20 border-b border-gray-200 dark:border-gray-700">
                <tr>
                  ...
                  <th className="px-4 py-3 text-left">
                    <button
                      onClick={() => handleSort("warrantyProvider")}
                      className="flex items-center gap-1 text-sm font-semibold text-gray-700 dark:text-gray-300 hover:text-gray-900 dark:hover:text-gray-100"
                      style={{ fontFamily: 'Inter, system-ui, -apple-system, sans-serif' }}
                    >
                      Warranty Provider
                  ...
                  <th className="px-4 py-3 text-left">
                    <button
                      onClick={() => handleSort("warrantyDetail")}
                      className="flex items-center gap-1 text-sm font-semibold text-gray-700 dark:text-gray-300 hover:text-gray-900 dark:hover:text-gray-100"
                      style={{ fontFamily: 'Inter, system-ui, -apple-system, sans-serif' }}
                    >
                      Warranty Detail
