      ...
      <div className="prose prose-lg max-w-none dark:prose-invert" style={{ fontFamily: 'Inter, system-ui, -apple-system, sans-serif' }}>
        <div className="space-y-6 text-gray-700 dark:text-gray-300">
          ...
          <p className="text-base leading-relaxed">
            By using AssetTiger (the "Service"), you agree to the following terms and conditions ("Terms of Service"). AssetTiger is owned and operated by SmartSign, LLC (the "Company"), based in Brooklyn, New York. The Company reserves the right to update and change these Terms of Service without notice. Your account may be terminated if you violate any of the Terms of Service.
          </p>

          {/* Section 1: Purpose of the Service */}
          <section className="space-y-4">
            <h2 className="text-xl font-semibold text-gray-900 dark:text-gray-50 mt-8 mb-4">1. Purpose of the Service.</h2>
            <p className="text-base leading-relaxed">
          ...
          <section className="space-y-4">
            <h2 className="text-xl font-semibold text-gray-900 dark:text-gray-50 mt-8 mb-4">2. Use of the Service</h2>
            <p className="text-base leading-relaxed">
          ...
          <section className="space-y-4">
            <h2 className="text-xl font-semibold text-gray-900 dark:text-gray-50 mt-8 mb-4">3. Prohibited acts.</h2>
            <p className="text-base leading-relaxed">
          ...
          <section className="space-y-4">
            <h2 className="text-xl font-semibold text-gray-900 dark:text-gray-50 mt-8 mb-4">4. User accounts.</h2>
            <p className="text-base leading-relaxed">
          ...
          <section className="space-y-4">
            <h2 className="text-xl font-semibold text-gray-900 dark:text-gray-50 mt-8 mb-4">5. Subscription Terms.</h2>
            <p className="text-base leading-relaxed">
            ...
            <p className="text-base leading-relaxed">
              <strong>5.4</strong> Suspended accounts will be retained for 30 days following the suspension date. After 30 days, AssetTiger cannot guarantee that account data will remain recoverable, even if technically retained in our systems.
            </p>
            <p className="text-base leading-relaxed">
          ...
          <section className="space-y-4">
            <h2 className="text-xl font-semibold text-gray-900 dark:text-gray-50 mt-8 mb-4">6. User content.</h2>
            <p className="text-base leading-relaxed">
          ...
          <section className="space-y-4">
            <h2 className="text-xl font-semibold text-gray-900 dark:text-gray-50 mt-8 mb-4">7. Third-party accounts.</h2>
            <p className="text-base leading-relaxed">
          ...
          <section className="space-y-4">
            <h2 className="text-xl font-semibold text-gray-900 dark:text-gray-50 mt-8 mb-4">8. Links to and from other websites.</h2>
            <p className="text-base leading-relaxed">
          ...
          <section className="space-y-4">
            <h2 className="text-xl font-semibold text-gray-900 dark:text-gray-50 mt-8 mb-4">9. Intellectual property rights.</h2>
            <p className="text-base leading-relaxed">
          ...
          <section className="space-y-4">
            <h2 className="text-xl font-semibold text-gray-900 dark:text-gray-50 mt-8 mb-4">10. Use of cookies.</h2>
            <p className="text-base leading-relaxed">
          ...
          <section className="space-y-4">
            <h2 className="text-xl font-semibold text-gray-900 dark:text-gray-50 mt-8 mb-4">11. Disclaimer of warranties; limitation of liability</h2>
            <p className="text-base leading-relaxed">
            ...
            <ul className="list-disc list-inside space-y-2 ml-4">
              ...
              <li>The quality of any products, services, information, or other material obtained by you through the Service will meet your expectations; and</li>
          ...
          <section className="space-y-4">
            <h2 className="text-xl font-semibold text-gray-900 dark:text-gray-50 mt-8 mb-4">12. Intellectual property complaints.</h2>
            <p className="text-base leading-relaxed">
            ...
            <ul className="list-disc list-inside space-y-2 ml-4">
              ...
              <li>Identification or description of where the material that you claim is infringing is located on the Service, with enough detail that we may find it on the Service;</li>
              <li>Your postal address, telephone number, and email address;</li>
              <li>A statement by you that you have a good faith belief that the use of the material complained of is not authorized by the copyright or intellectual property owner, its agent, or the law; and</li>
              <li>A statement by you, made under penalty of perjury, that the information in your notice is accurate and that you are the copyright or intellectual property owner or authorized to act on the copyright or intellectual property owner's behalf.</li>
            </ul>
            <p className="text-base leading-relaxed">
              The Company's agent designated to receive claims of copyright or other intellectual property infringement may be contacted by email at <a href="mailto:customerservice@assettiger.com" className="text-orange-500 hover:underline">customerservice@assettiger.com</a>. The Company has adopted and implements a policy that provides for the termination in appropriate circumstances of the accounts of users who repeatedly infringe copyrights or other intellectual property rights of the Company and others. For more details on the information required for valid DMCA notification, see 17 U.S.C. § 512(c)(3). You should be aware that, under the DMCA, claimants who make misrepresentations concerning copyright infringement may be liable for damages incurred as a result of the removal or blocking of the material, court costs, and attorney fees.
            </p>
          </section>

          {/* Section 13: Assignability */}
          <section className="space-y-4">
            <h2 className="text-xl font-semibold text-gray-900 dark:text-gray-50 mt-8 mb-4">13. Assignability.</h2>
            <p className="text-base leading-relaxed">
          ...
          <section className="space-y-4">
            <h2 className="text-xl font-semibold text-gray-900 dark:text-gray-50 mt-8 mb-4">14. Termination.</h2>
            <p className="text-base leading-relaxed">
              These Terms of Service apply when you first use the Service, and will continue until:
            </p>
            <ul className="list-disc list-inside space-y-2 ml-4">
              <li>your account is terminated; or</li>
              <li>the Company ceases to provide the Service.</li>
            </ul>
            <p className="text-base leading-relaxed">
          ...
          <section className="space-y-4">
            <h2 className="text-xl font-semibold text-gray-900 dark:text-gray-50 mt-8 mb-4">15. Privacy policy.</h2>
            <p className="text-base leading-relaxed">
              Data provided to the Service is subject to the AssetTiger Privacy Policy. The Company reserves the right to update the Privacy Policy at any time.
            </p>
          </section>

          {/* Section 16: Disputes */}
          <section className="space-y-4">
            <h2 className="text-xl font-semibold text-gray-900 dark:text-gray-50 mt-8 mb-4">16. Disputes.</h2>
            <p className="text-base leading-relaxed">
          ...
          <section className="space-y-4">
            <h2 className="text-xl font-semibold text-gray-900 dark:text-gray-50 mt-8 mb-4">17. General provisions.</h2>
            <p className="text-base leading-relaxed">
