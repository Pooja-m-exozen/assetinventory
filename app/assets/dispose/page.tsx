  ...
  return (
    <div className="min-h-screen bg-white dark:bg-gray-900 p-6">
      <div className="max-w-4xl mx-auto">
        ...
        >
          Follow your assets every step of the way until they're gone. Rather than deleting an asset from your database, you can dispose of it and have documentation of its entire life.
        </p>
