...
export default function CheckoutReportsBySiteLocationPage() {
  const [currentPage, setCurrentPage] = useState(1);
  const [itemsPerPage, setItemsPerPage] = useState(100);
  const [filterResult, setFilterResult] = useState("Current Status");
  const [selectedSiteLocation, setSelectedSiteLocation] = useState("Casagrand Boulevard / Car washer");
        ...
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center gap-3">
            ...
            <h1 className="text-2xl font-bold text-gray-900 dark:text-gray-50" style={{ fontFamily: 'Inter, system-ui, -apple-system, sans-serif', fontSize: '24px' }}>
              Report Check-Out by Site/Location
            </h1>
          </div>
          ...
          <div className="flex items-center gap-4 flex-wrap">
            ...
            <div className="flex items-center gap-2">
              ...
              <select
                ...
                style={{ fontFamily: 'Inter, system-ui, -apple-system, sans-serif' }}
              >
                <option value="Casagrand Boulevard / Car washer">Casagrand Boulevard / Car washer</option>
                <option value="Site 2 / Location 2">Site 2 / Location 2</option>
                <option value="Site 3 / Location 3">Site 3 / Location 3</option>
              </select>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden">
          <div className="px-6 py-8">
            <div className="text-center">
              <p className="text-sm font-bold text-gray-900 dark:text-gray-50 mb-2" style={{ fontFamily: 'Inter, system-ui, -apple-system, sans-serif' }}>
                Site / Location: <span className="font-bold">{selectedSiteLocation}</span>
              </p>
              <p className="text-sm text-gray-600 dark:text-gray-400" style={{ fontFamily: 'Inter, system-ui, -apple-system, sans-serif' }}>
                No assets assigned in this Site / Location.
              </p>
            </div>
          </div>
