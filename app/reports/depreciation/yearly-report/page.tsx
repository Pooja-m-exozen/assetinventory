...
interface YearlyDepreciationAsset {
  id: string;
  assetTagId: string;
  description: string;
  dateAcquired: string;
  ...
  bookValue: number;
  annualDepExpense: number;
  endOfServiceLife: string;
}

const dummyAssets: YearlyDepreciationAsset[] = [
  {
    id: "1",
    ...
    bookValue: 10000.00,
    annualDepExpense: 2000.00,
    endOfServiceLife: "10/31/2026",
  },
];

export default function DepreciationReportsYearlyReportPage() {
        ...
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center gap-3">
            ...
            <h1 className="text-2xl font-bold text-gray-900 dark:text-gray-50" style={{ fontFamily: 'Inter, system-ui, -apple-system, sans-serif', fontSize: '24px' }}>
              Report Yearly Asset Depreciation
            </h1>
          </div>
              ...
              <tbody className="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                {paginatedAssets.map((asset) => (
                  <tr key={asset.id} className="hover:bg-gray-50 dark:hover:bg-gray-700">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900 dark:text-gray-200" style={{ fontFamily: 'Inter, system-ui, -apple-system, sans-serif' }}>
                      ₹{asset.annualDepExpense.toLocaleString('en-IN', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900 dark:text-gray-200" style={{ fontFamily: 'Inter, system-ui, -apple-system, sans-serif' }}>
