...
export default function DepreciationReportsQuarterlyReportPage() {
  ...
  const periodText = `Period: ${selectedQuarter} ${selectedYear} (${getQuarterMonths(selectedQuarter)} ${selectedYear})`;
        ...
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center gap-3">
            ...
            <h1 className="text-2xl font-bold text-gray-900 dark:text-gray-50" style={{ fontFamily: 'Inter, system-ui, -apple-system, sans-serif', fontSize: '24px' }}>
              Report Quarterly Asset Depreciation
            </h1>
          </div>
