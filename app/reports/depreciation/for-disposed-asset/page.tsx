...
export default function DepreciationReportsForDisposedAssetPage() {
        ...
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center gap-3">
            ...
            <h1 className="text-2xl font-bold text-gray-900 dark:text-gray-50" style={{ fontFamily: 'Inter, system-ui, -apple-system, sans-serif', fontSize: '24px' }}>
              Report Asset Depreciation for Disposed Asset
            </h1>
          </div>
        ...
        <div className="flex items-center justify-between mb-4 flex-wrap gap-4">
          <div className="flex items-center gap-4 flex-wrap">
            ...
            <div className="text-sm text-gray-600 dark:text-gray-400" style={{ fontFamily: 'Inter, system-ui, -apple-system, sans-serif' }}>
              Depreciation Report for: <span className="font-bold text-gray-900 dark:text-gray-200">Disposed / Donated / Sold Assets</span>
            </div>
          </div>
          <div className="flex items-center gap-2">
            <Button
