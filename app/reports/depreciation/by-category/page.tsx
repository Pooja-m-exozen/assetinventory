...
export default function DepreciationReportsByCategoryPage() {
  ...
  const categories = ["Asset", "Equipment", "Vehicle"];
        ...
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center gap-3">
            ...
            <h1 className="text-2xl font-bold text-gray-900 dark:text-gray-50" style={{ fontFamily: 'Inter, system-ui, -apple-system, sans-serif', fontSize: '24px' }}>
              Report Asset Depreciation by Category
            </h1>
          </div>
            ...
            <div className="flex items-center gap-1">
              <button
                ...
                className={cn(
                  ...
                  categories.indexOf(selectedCategory) === 0 && "opacity-50 cursor-not-allowed"
                )}
              >
              ...
              <button
                ...
                className={cn(
                  "p-1.5 rounded hover:bg-gray-100 dark:hover:bg-gray-700",
                  categories.indexOf(selectedCategory) === categories.length - 1 && "opacity-50 cursor-not-allowed"
                )}
              >
