...
export default function NonAuditedAssetsPage() {
  ...
  const [dateRange, setDateRange] = useState("MM/dd/yyyy - MM/dd/yyyy");
          ...
          <div className="flex items-center gap-4 flex-wrap">
            <div className="flex items-center gap-2">
              ...
              <select
                ...
                onChange={(e) => setSelectedAuditName(e.target.value)}
            ...
            <div className="flex items-center gap-2">
              ...
              <select
                value={dateRangeBy}
                onChange={(e) => setDateRangeBy(e.target.value)}
                className="px-3 py-1.5 border border-gray-300 dark:border-gray-600 rounded-md bg-white dark:bg-gray-700 text-sm focus:outline-none focus:ring-2 focus:ring-yellow-500"
                style={{ fontFamily: 'Inter, system-ui, -apple-system, sans-serif' }}
              >
